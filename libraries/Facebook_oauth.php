...
class Facebook_oauth
{
	...
	public $verifypeer 		= FALSE;	// Verify SSL Cert
	...
	public $http_info = array();	// Contains the last HTTP headers returned.
	public $url;					// Contains the last API call.
	public $http_header = array();	// Contains last http_headers
	...
	function __construct($facebook_config)
	{
		$this->client_id		= $facebook_config['client_id'];
		$this->client_secret	= $facebook_config['client_secret'];
		$this->callback_url		= $facebook_config['callback_url'];
		$this->access_token		= $facebook_config['access_token'];
	}
